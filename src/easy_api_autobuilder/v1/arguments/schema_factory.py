...
class ListParamsArguments(BaseModel):
    excluded: set | None = None


class BaseCreationArguments(ListParamsArguments):
...
class SchemaCreationArguments(BaseModel):
    ...
    list_params: ListParamsArguments = Field(default_factory=ListParamsArguments)
