...
from easy_api_autobuilder.v1.schema import BaseSchemaCreationStrategy, StrategyReturn
...
ServiceHandlersType = Literal["list", "detail", "post", "put", "delete"]
...
class BaseView(LoggerMixin):
    ...
    def _add_api_route(
        self,
        service_handler: ServiceHandlersType,
        annotations: StrategyReturn,
        route: str,
        service_deps: DependsClass,
        service: type[BaseService | SecondaryBaseService],
        dependencies: list[DependsClass] | None = None,
    ) -> None:
    ...
    def _create_main_handler(self, service_handler: ServiceHandlersType) -> None:
        ...
        self._add_api_route(
            ...
            self._main_service,
            self.dependencies.get(service_handler),
        )
    ...
    def _eval_params_annotation(self, annotations: StrategyReturn) -> Annotated | None:
        return (
            Annotated[annotations.request.params, Depends(annotations.request.params.params_deps(self.logger))]
