...
from easy_api_autobuilder.v1.arguments import SchemaCreationArguments
from easy_api_autobuilder.v1.page import Page, PageParams

from .base import BaseModel, BaseParams, IntegerIdSchema, UUIDIdSchema
...
class SchemaCreationStrategy(BaseSchemaCreationStrategy):
    ...
    def list(self) -> StrategyReturn:
        ...
        params_schema = self._schema_factory.create_params_from_model(
            PageParams, excluded=self.arguments.list_params.excluded
        )
